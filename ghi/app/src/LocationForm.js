...
class LocationForm extends React.Component {
    ...
    async handleSubmit(event) {
        ...
        if (response.ok) {
          ...
          console.log("New Location API: ", newLocation);
          ...
          <div className="offset-3 col-6">
            <div className="shadow p-4 mt-4">
              ...
              <form onSubmit={this.handleSubmit} id="create-location-form">
                ...
                {/* State */}
                <div className="mb-3">
                  <select required name="state" id="state" className="form-select" onChange={this.handleStateChange} value={this.state.state}>
